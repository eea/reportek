# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-01-09 14:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instrument', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.Instrument')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qa_xmlrpc_uri', models.CharField(default='http://localhost:1082/RpcRouter', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('obligation_spec', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.ObligationSpec')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.ReporterSubdivisionCategory'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='envelope',
            name='obligation',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Obligation'),
        ),
        migrations.AddField(
            model_name='envelope',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.ReportingCycle'),
        ),
        migrations.AddField(
            model_name='envelope',
            name='workflow',
