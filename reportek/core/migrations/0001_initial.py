# Generated by Django 2.0.4 on 2018-04-12 09:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='BaseEnvelopeFile',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('core.envelopefile', 'envelope file'), ('core.envelopesupportfile', 'envelope support file')], db_index=True, max_length=255)),
                ('file', models.FileField(max_length=512, storage=reportek.core.models.reporting.OverwriteFileSystemStorage(), upload_to=reportek.core.models.reporting.BaseEnvelopeFile.get_envelope_directory)),
        ...
        migrations.AddField(
            model_name='baseenvelopefile',
            name='original_file',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='converted_files', to='core.BaseEnvelopeFile'),
        ),
        migrations.AddField(
            model_name='baseenvelopefile',
            name='uploader',
